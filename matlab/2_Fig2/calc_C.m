...
exportgraphics(fig, fullfile(outDir, 'seizure_01_C_all_timecourse_nature_labeled.png'), 'Resolution', 600);
savefig(fig, fullfile(outDir, 'seizure_01_C_all_timecourse_nature_labeled.fig'));
