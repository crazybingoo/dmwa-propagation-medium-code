...
fig <- p_a / (p_b | p_c) +
  ...
  theme(
    plot.tag = element_text(size = FIG_PANEL_PT, face = "bold", family = "Arial", colour = "#111111"),
...
base_file <- file.path(out_dir, "Fig7_eta_ablation_components_method_highlight_softer_delta_label_clear_dmwhlg_label_font6_label8")
...
writeLines(
  c(
    ...
    "Softer method-highlighting delta-label-clear DMW-HLG-label version: Fig7_eta_ablation_components_method_highlight_softer_delta_label_clear_dmwhlg_label_font6_label8.*",
