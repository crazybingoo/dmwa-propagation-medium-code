...
base_file <- file.path(out_dir, "Fig7_eta_ablation_components_method_highlight_softer_delta_label_clear_dmwhlg_label")
...
writeLines(
  c(
    ...
    "Softer method-highlighting delta-label-clear DMW-HLG-label version: Fig7_eta_ablation_components_method_highlight_softer_delta_label_clear_dmwhlg_label.*",
