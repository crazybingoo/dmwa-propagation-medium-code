...
imagesc(c_range, h_range, R.lambda1_mean);
axis xy;
colormap(parula);
cb = colorbar;
cb.Label.String = '\lambda_1';
...
title('\lambda_1 phase diagram', 'FontName', 'Arial', 'FontSize', 13, 'FontWeight', 'bold');

set(gca, 'FontName', 'Arial', 'FontSize', 11, 'LineWidth', 1.1, ...
    'Box', 'off', 'TickDir', 'out');

exportgraphics(fig, fullfile(outDir, 'Fig3_lambda1_phase_diagram.png'), 'Resolution', 600);
exportgraphics(fig, fullfile(outDir, 'Fig3_lambda1_phase_diagram.pdf'), 'ContentType', 'vector');
savefig(fig, fullfile(outDir, 'Fig3_lambda1_phase_diagram.fig'));
